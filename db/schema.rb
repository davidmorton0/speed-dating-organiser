...
ActiveRecord::Schema.define(version: 20_220_131_071_808) do
  ...
  create_table 'daters', force: :cascade do |t|
    ...
    t.index %w[invited_by_type invited_by_id], name: 'index_daters_on_invited_by'
  ...
  create_table 'reps', force: :cascade do |t|
    ...
    t.index %w[invited_by_type invited_by_id], name: 'index_reps_on_invited_by'
